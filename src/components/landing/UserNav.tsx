...
export function UserNav() {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute right-0 top-full mt-5 w-56 rounded-md bg-black border border-gray-800 shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
        <div className="p-2">
          ...
          <div className="pt-2 space-y-1">
            <Link to="/profile" className="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:text-white hover:bg-gray-800">

  ...
  return (
    <div className="relative min-h-[55vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      <div className="relative animate-fade-up z-10">
        ...
        <p className="text-xl md:text-2xl font-semibold text-gray-700 mb-6 max-w-2xl">Boost Your Prompts, Empower Your AI.</p>
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mb-8">
          Manage, optimize, and master your AI prompts in one place. Get AI-powered suggestions and best practices to make your prompts more effective.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 sm:space-x-4 justify-center">
          <Button size="lg" className="bg-[#2C106A] hover:bg-[#2C106A]/90 text-white px-8 w-full sm:w-auto">
            Start Managing Prompts
          </Button>
          <Button size="lg" variant="outline" className="border-[#2C106A] text-[#2C106A] hover:bg-[#2C106A]/10 w-full sm:w-auto">
